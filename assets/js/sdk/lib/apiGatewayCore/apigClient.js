...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://b0em6psfz7.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.uploadBucketItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['item', 'bucket', 'x-amz-meta-customLabels'], ['body']);
        ...
        return apiGatewayClient.makeRequest(uploadBucketItemPutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.uploadBucketItemOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-customLabels'], ['body']);
        
        var uploadBucketItemOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{bucket}/{item}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(uploadBucketItemOptionsRequest, authType, additionalParams, config.apiKey);
    };
